...
If you're working from a second checkout/worktree of this repo (not the
one you normally edit in), run `git log --oneline -1` there too before
editing -- a checkout that's behind `origin/main` will happily let you
